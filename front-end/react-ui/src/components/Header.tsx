          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              <div className="shrink-0">
                ...
                >
                  <svg
                    className="stroke-primary-500 dark:stroke-primary-300 h-8"
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                {links.map((link) => (
                  <li key={link.label} className="shrink-0">
                    <Link
                      to={link.href}
                      title={link.label}
                      className="[&.active]:font-bold flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <div className="flex items-center lg:space-x-2">
              ...
              <button
                type="button"
                data-collapse-toggle="todos-navbar-menu-1"
                aria-controls="todos-navbar-menu-1"
                aria-expanded="false"
            ...
            <ul className="text-gray-900 dark:text-white text-sm font-medium space-y-3">
              {links.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="[&.active]:font-bold hover:text-primary-700 dark:hover:text-primary-500"
                  >
                    {link.label}
                  </a>
                </li>
