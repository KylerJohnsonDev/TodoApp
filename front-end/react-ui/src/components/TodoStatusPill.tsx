export default function TodoStatusPill({ status }: { status: string }) {
  const pillBaseClasses =
    'inline-flex items-center rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium';
  ...
  const pillColorBasedOnStatus =
    pillColorClassesByStatus[status] ?? pillBaseClasses['incomplete'];
